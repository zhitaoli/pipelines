...
import (
	...
	tensorboard "github.com/kubeflow/pipelines/backend/src/crd/pkg/client/informers/externalversions/tensorboard"
...
type SharedInformerFactory interface {
	...
	Tensorboard() tensorboard.Interface
}
...
func (f *sharedInformerFactory) Tensorboard() tensorboard.Interface {
	return tensorboard.New(f, f.namespace, f.tweakListOptions)
}
